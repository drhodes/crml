...
# ADD CPP /nologo /MD /W4 /GX /Zi /O2 /I "include/VG" /I "include/EGL" /I "src" /I "../lib" /D "GLUT_NO_LIB_PRAGMA" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OPENVG_DLL_EXPORTS" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 glut32.lib opengl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /pdb:"bin/openvg_ri.pdb" /debug /machine:I386 /nodefaultlib:"libcmt" /out:"../bin/win32/libOpenVG.dll" /libpath:"../lib"
...
# ADD CPP /nologo /MTd /W4 /GX /Zi /Od /I "include/VG" /I "include/EGL" /I "src" /I "../lib" /D "GLUT_NO_LIB_PRAGMA" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OPENVG_DLL_EXPORTS" /FD /GZ /c
# SUBTRACT CPP /YX
...
# ADD LINK32 glut32.lib opengl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"bin/openvg_ri-dbg.pdb" /debug /machine:I386 /nodefaultlib:"libcmt" /out:"../bin/win32/libOpenVG-dbg.dll" /pdbtype:sept /libpath:"../lib"
# SUBTRACT LINK32 /pdb:none
