...
\section{/home/derek/dev/crml/crml/src/sys/tmp/jslog.cc File Reference}
\label{jslog_8cc}\index{/home/derek/dev/crml/crml/src/sys/tmp/jslog.cc@{/home/derek/dev/crml/crml/src/sys/tmp/jslog.cc}}
}
\subsection*{Defines}
...
\begin{DoxyCompactItemize}
\item 
bool \hyperlink{jslog_8cc_a1d5b6de7ad081ba4f13d8d98e7d3ee8a}{Log} (NPP npp, const char $\ast$msg,...)
\end{DoxyCompactItemize}
...
\subsubsection[{Log}]{\setlength{\rightskip}{0pt plus 5cm}bool Log (NPP {\em npp}, \/  const char $\ast$ {\em msg}, \/   {\em ...})}}
